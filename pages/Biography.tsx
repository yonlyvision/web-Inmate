                ...
                <div className="grid lg:grid-cols-2 gap-32 items-center">
                    <motion.div {...fadeInUp} className="space-y-16">
                        <div className="space-y-8">
                            ...
                            <h2 className="font-serif text-6xl font-black text-white leading-tight tracking-tighter">Why <br /><span className="italic text-stone-500 uppercase">INM8TE <span className="text-primary lowercase">book</span>?</span></h2>
                        </div>

                        <div className="space-y-10 text-xl text-stone-400 font-light italic leading-relaxed max-w-xl">
                            <p>
                                The name <strong className="text-white not-italic font-black italic">INM8TE <span className="text-primary lowercase font-serif italic">book</span></strong> is more than just a play on words. It represents the shared human experience of feeling trapped—whether by our past, our circumstances, or our own limiting beliefs.
                            </p>
                            <p>
